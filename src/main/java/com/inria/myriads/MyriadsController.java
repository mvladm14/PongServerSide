...
public class MyriadsController {
	...
	@RequestMapping(value = PongSvcApi.PONG_PLAYERS, method = RequestMethod.GET)
	public @ResponseBody Collection<Player> getPlayersList() {
		return players.values();
	}

	@RequestMapping(value = PongSvcApi.PONG_PLAYERS, method = RequestMethod.POST)
	public @ResponseBody Player addPlayer(@RequestBody Player player) {
		savePlayer(player);
		return player;
	}

	@RequestMapping(value = PongSvcApi.PONG_PLAYER_PATH, method = RequestMethod.GET)
	...
	@RequestMapping(value = PongSvcApi.PONG_PLAYER_PATH, method = RequestMethod.POST)
